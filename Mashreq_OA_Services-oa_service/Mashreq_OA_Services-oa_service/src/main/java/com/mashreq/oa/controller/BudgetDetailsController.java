...
public class BudgetDetailsController {
	...
	//for reversal
	    ...
	    public ResponseEntity<List<BudgetDetailsOutput>> updateBudgetItems(@RequestBody Reversal reversal,@RequestHeader Map<String,String> headers) 
		{
			...
			logger.info("BudgetDetailsController class updateBudgetItems()-Reversal Data: "+reversal);
	       
	        try 
	        {
	        	String username=headers.get("username");
	        	List<BudgetDetailsOutput> data = budgetDetailsService.updateBudgetItems(reversal,username);
	    ...
	    public ResponseEntity<List<AuditTrailLog>> fetchAuditTrailLog2(@RequestParam String serviceCode,@RequestParam String userName,@RequestParam @DateTimeFormat(pattern = "dd-MM-yyyy") Date updatedFrom,@RequestParam @DateTimeFormat(pattern = "dd-MM-yyyy") Date updatedTo,@RequestParam String mgmtCompId,@RequestParam String buildingId) 
		{
			List<AuditTrailLog> data = null;
			logger.info("BudgetDetailsController class fetchAuditTrailLog2()-Audit Data: ");
	        ...
	        try 
	        {
	            ...
	            data = budgetDetailsService.getDataFromAuditTrailLog(serviceCode, userName, updatedFrom,updatedTo,mgmtCompId,buildingId);
	    ...
	    public ResponseEntity<List<BudgetDetailsOutput>> updateServiceCode(@RequestBody Reversal reversalEdit,@RequestHeader Map<String,String> headers) 
		{
			...
			logger.info("Calling updateServiceCode() in BudgetDetailsController");
	        try 
	        {
	        	String username=headers.get("username");
	        	System.out.println("username:"+username);
	        	List<BudgetDetailsOutput> data = budgetDetailsService.updateServiceCode(reversalEdit,username);
