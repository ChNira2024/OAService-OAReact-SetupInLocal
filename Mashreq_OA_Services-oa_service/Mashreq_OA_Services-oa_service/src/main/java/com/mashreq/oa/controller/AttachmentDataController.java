...
//	}
	...
	/*
	 * Fetch MatrixRefNo using pymtReqId
	 */
	...
	/*
	 * Fetch all List of AttachmentData from OA_ATTACHMENTS_DATA 
	 */
	...
	//fetching TRADE_LICENSE_EXP_DATE, ENTITY_TYPE, AUTO_RENEWAL from OA_SUPPLIERS using SUPPLIER_ID
	//fetching AGREEMENT_EXP_DATE from OA_AGREEMENT_DETAILS using SUPPLIER_ID and MGMT_COMP_ID
