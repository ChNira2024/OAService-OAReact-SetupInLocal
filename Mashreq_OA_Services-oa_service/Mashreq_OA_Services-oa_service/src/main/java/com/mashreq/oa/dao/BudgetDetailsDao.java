...
public interface BudgetDetailsDao {
	...
	public List<BudgetDetailsOutput> getBudgetItemById(Integer budgetItemId); //for reversal
	...
	public List<AuditTrailLog> fetchAuditTrailLog(String serviceCode,String userName,Date updatedFrom,Date updatedTo,String mgmtCompId,String bildingId); //for fetchAudit Trail Log
	
	public void updateBudgetItemTableWithServiceCode(BudgetDetailsOutput budgetItem);//for update Service
}
